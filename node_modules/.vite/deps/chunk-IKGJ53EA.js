...
var ReactiveElement = class extends HTMLElement {
  ...
  __initialize() {
    ...
    this.requestUpdate();
    (_a6 = this.constructor._initializers) == null ? void 0 : _a6.forEach((i) => i(this));
  }
  /**
  ...
  connectedCallback() {
    ...
    (_a6 = this.__controllers) == null ? void 0 : _a6.forEach((c) => {
      var _a7;
      return (_a7 = c.hostConnected) == null ? void 0 : _a7.call(c);
    });
  }
  /**
  ...
  disconnectedCallback() {
    ...
    (_a6 = this.__controllers) == null ? void 0 : _a6.forEach((c) => {
      var _a7;
      return (_a7 = c.hostDisconnected) == null ? void 0 : _a7.call(c);
    });
  }
  /**
  ...
  performUpdate() {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        (_a6 = this.__controllers) == null ? void 0 : _a6.forEach((c) => {
          var _a7;
          return (_a7 = c.hostUpdate) == null ? void 0 : _a7.call(c);
        });
  ...
  _$didUpdate(changedProperties) {
    ...
    (_a6 = this.__controllers) == null ? void 0 : _a6.forEach((c) => {
      var _a7;
      return (_a7 = c.hostUpdated) == null ? void 0 : _a7.call(c);
    });
    if (!this.hasUpdated) {
...
var ChildPart = class _ChildPart {
  ...
  _$clear(start = wrap(this._$startNode).nextSibling, from) {
    var _a6;
    (_a6 = this._$notifyConnectionChanged) == null ? void 0 : _a6.call(this, false, true, from);
...
function clone(configObject) {
  ...
  convertBase = /* @__PURE__ */ function() {
    ...
    return function(str, baseIn, baseOut, sign, callerIsToString) {
      var alphabet, d2, e, k2, r, x, xc, y, i = str.indexOf("."), dp = DECIMAL_PLACES, rm = ROUNDING_MODE;
      if (i >= 0) {
        k2 = POW_PRECISION;
        POW_PRECISION = 0;
        str = str.replace(".", "");
  ...
  function round(x, sd, rm, r) {
    var d2, i, j, k2, n, ni, rd, xc = x.c, pows10 = POWS_TEN;
    if (xc) {
      out: {
        ...
        if (i == 0) {
          ...
          xc[ni] = j > 0 ? mathfloor(n / pows10[d2 - j] % pows10[j]) * k2 : 0;
        }
        if (r) {
          for (; ; ) {
            if (ni == 0) {
...
// node_modules/@web3modal/ui/dist/esm/src/assets/svg/farcaster.js
...
// node_modules/@web3modal/ui/dist/esm/src/assets/svg/three-dots.js
...
// node_modules/@web3modal/ui/dist/esm/src/assets/svg/lightbulb.js
  ...
  update(part, [classInfo]) {
    ...
    if (this._previousClasses === void 0) {
      ...
      for (const name in classInfo) {
        if (classInfo[name] && !((_a6 = this._staticClasses) == null ? void 0 : _a6.has(name))) {
...
// node_modules/@web3modal/ui/dist/esm/src/assets/visual/meld.js
...
// node_modules/@web3modal/ui/dist/esm/src/composites/wui-dropdown-menu/styles.js
...
// node_modules/@web3modal/ui/dist/esm/src/composites/wui-dropdown-menu/index.js
...
var WuiSnackbar = class WuiSnackbar2 extends LitElement {
  ...
  render() {
    return html`
      ${this.loading ? html`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>` : html`<wui-icon-box
            size="sm"
            iconSize="xs"
...
WuiTabs.styles = [resetStyles, elementStyles, styles_default46];
__decorate46([
  property({ type: Array })
...
WuiTokenButton.styles = [resetStyles, elementStyles, styles_default47];
__decorate47([
  property()
...
WuiTooltip.styles = [resetStyles, elementStyles, styles_default48];
__decorate48([
  property()
...
WuiTokenListItem.styles = [resetStyles, elementStyles, styles_default49];
__decorate49([
  property()
...
WuiVisualThumbnail.styles = [resetStyles, styles_default50];
__decorate50([
  property()
...
WuiVisualThumbnail = __decorate50([
...
WuiNoticeCard.styles = [resetStyles, elementStyles, styles_default51];
__decorate51([
  property()
...
WuiListAccordion.styles = [resetStyles, elementStyles, styles_default52];
__decorate52([
  property()
...
WuiListContent.styles = [resetStyles, elementStyles, styles_default53];
__decorate53([
  property()
...
WuiListNetwork.styles = [resetStyles, elementStyles, styles_default54];
__decorate54([
  property()
...
WuiListWalletTransaction.styles = [resetStyles, elementStyles, styles_default55];
__decorate55([
  property()
...
WuiListWalletTransaction = __decorate55([
...
WuiPromo.styles = [resetStyles, elementStyles, styles_default56];
__decorate56([
  property()
], WuiPromo.prototype, "text", void 0);
WuiPromo = __decorate56([
...
WuiBalance.styles = [resetStyles, styles_default57];
__decorate57([
  property()
...
WuiProfileButton.styles = [resetStyles, elementStyles, styles_default58];
__decorate58([
  property()
...
WuiProfileButton = __decorate58([
  customElement("wui-profile-button")
], WuiProfileButton);

// node_modules/@web3modal/ui/dist/esm/src/composites/wui-profile-button-v2/styles.js
...
function proxyMap(entries2) {
  const map = proxy({
    ...
    get(key) {
      var _a6;
      return (_a6 = this.data.find((p) => p[0] === key)) == null ? void 0 : _a6[1];
    },
    delete(key) {
...
var ThemeController = {
  ...
  setThemeVariables(themeVariables) {
    state3.themeVariables = { ...state3.themeVariables, ...themeVariables };
    try {
      const authConnector = ConnectorController.getAuthConnector();
      if (authConnector) {
        ...
        authConnector.provider.syncTheme({
          ...
          w3mThemeVariables: getW3mThemeVariables(state3.themeVariables, state3.themeMode)
        });
      }
    } catch {
      console.info("Unable to sync theme to auth connector");
...
var ConnectorController = {
  ...
  setConnectors(connectors) {
    ...
    state4.unMergedConnectors = [...state4.unMergedConnectors, ...connectors].filter((connector) => {
      try {
    ...
    state4.connectors = this.mergeMultiChainConnectors(state4.unMergedConnectors);
  },
  mergeMultiChainConnectors(connectors) {
    ...
    const refactoredConnectors = Array.from(connectorsByNameMap.values()).map((_connectors) => {
      ...
      if (_connectors.length > 1) {
        return {
          name: (_a6 = _connectors[0]) == null ? void 0 : _a6.name,
          imageUrl: (_b3 = _connectors[0]) == null ? void 0 : _b3.imageUrl,
  ...
  getAuthConnector() {
    return state4.connectors.find((c) => c.type === "AUTH");
  },
  getAnnouncedConnectorRdns() {
    return state4.connectors.filter((c) => c.type === "ANNOUNCED").map((c) => {
      var _a6;
      return (_a6 = c.info) == null ? void 0 : _a6.rdns;
    });
  },
  getConnectors() {
  ...
  getConnector(id, rdns) {
    return state4.connectors.find((c) => {
      var _a6;
      return c.explorerId === id || ((_a6 = c.info) == null ? void 0 : _a6.rdns) === rdns;
    });
  },
...
var ChainController = {
  ...
  subscribeChainProp(property2, callback) {
    let prev = void 0;
    return subscribe(state7.chains, () => {
      var _a6;
      const activeChain = state7.activeChain;
      if (activeChain) {
        const nextValue = (_a6 = state7.chains.get(activeChain)) == null ? void 0 : _a6[property2];
        if (prev !== nextValue) {
          prev = nextValue;
          callback(nextValue);
        }
  ...
  setActiveChain(chain) {
    ...
    if (newAdapter && newAdapter.chain !== state7.activeChain) {
      ...
      state7.activeCaipNetwork = ((_a6 = newAdapter.networkState) == null ? void 0 : _a6.caipNetwork) ? ref((_b3 = newAdapter.networkState) == null ? void 0 : _b3.caipNetwork) : void 0;
  ...
  getAccountProp(key, _chain) {
    ...
    const chainAccountState = (_a6 = state7.chains.get(chain)) == null ? void 0 : _a6.accountState;
  ...
  getNetworkProp(key) {
    ...
    const chainNetworkState = (_a6 = state7.chains.get(chainToWrite)) == null ? void 0 : _a6.networkState;
...
var NetworkController = {
  ...
  replaceState(newState) {
    ...
    Object.assign(state8, ref(newState));
  },
  subscribeKey(property2, callback) {
    let prev = void 0;
    return ChainController.subscribeChainProp("networkState", (networkState2) => {
      if (networkState2) {
        const nextValue = networkState2[property2];
        if (prev !== nextValue) {
          prev = nextValue;
          callback(nextValue);
        }
  ...
  setActiveCaipNetwork(caipNetwork) {
    ...
    if (!((_b3 = (_a6 = ChainController.state.chains.get(caipNetwork.chain)) == null ? void 0 : _a6.networkState) == null ? void 0 : _b3.allowUnsupportedChain)) {
  ...
  getRequestedCaipNetworks(chainToFilter) {
    ...
    chainAdapters.forEach((chn) => {
      ...
      if ((_b3 = (_a6 = ChainController.state.chains.get(chn)) == null ? void 0 : _a6.networkState) == null ? void 0 : _b3.approvedCaipNetworkIds) {
  ...
  async switchActiveNetwork(network) {
    var _a6;
    const networkControllerClient = network ? (_a6 = ChainController.state.chains.get(network.chain)) == null ? void 0 : _a6.networkControllerClient : void 0;
  ...
  getApprovedCaipNetworkIds(chainToFilter) {
    ...
    if (chainToFilter) {
      ...
      return (_b3 = (_a6 = ChainController.state.chains.get(chain)) == null ? void 0 : _a6.networkState) == null ? void 0 : _b3.approvedCaipNetworkIds;
    }
    ...
    Object.values(ChainController.state.chains).forEach((adapter) => {
      ...
      if (adapter.networkState.approvedCaipNetworkIds) {
        allCaipNetworkIds.push(...((_a7 = adapter.networkState) == null ? void 0 : _a7.approvedCaipNetworkIds) || []);
      }
    });
  ...
  checkIfSupportedNetwork() {
    ...
    const activeCaipNetwork = (_b3 = (_a6 = ChainController.state.chains.get(chain)) == null ? void 0 : _a6.networkState) == null ? void 0 : _b3.caipNetwork;
  ...
  checkIfSmartAccountEnabled() {
    var _a6;
    const networkId = NetworkUtil.caipNetworkIdToNumber((_a6 = state8.caipNetwork) == null ? void 0 : _a6.id);
  ...
  getSupportsAllNetworks() {
    ...
    return (_b3 = (_a6 = ChainController.state.chains.get(chain)) == null ? void 0 : _a6.networkState) == null ? void 0 : _b3.supportsAllNetworks;
  },
  ...
  getActiveNetworkTokenAddress() {
    var _a6, _b3;
    const address = ConstantsUtil2.NATIVE_TOKEN_ADDRESS[((_a6 = this.state.caipNetwork) == null ? void 0 : _a6.chain) || "evm"];
    return `${((_b3 = this.state.caipNetwork) == null ? void 0 : _b3.id) || "eip155:1"}:${address}`;
  }
};
...
var ApiController = {
  ...
  async fetchRecommendedWallets() {
    ...
    const { data, count } = await api2.get({
      ...
      params: {
        page: "1",
        chains: (_a6 = NetworkController.state.caipNetwork) == null ? void 0 : _a6.id,
    ...
    state9.recommended = data;
    state9.count = count ?? 0;
  },
  async fetchWallets({ page }) {
    var _a6;
    const { includeWalletIds, excludeWalletIds, featuredWalletIds } = OptionsController.state;
    const exclude = [
      ...state9.recommended.map(({ id }) => id),
      ...excludeWalletIds ?? [],
      ...featuredWalletIds ?? []
    ].filter(Boolean);
    const { data, count } = await api2.get({
    ...
    await Promise.allSettled(images.map((id) => ApiController._fetchWalletImage(id)));
    state9.wallets = CoreHelperUtil.uniqueBy([...state9.wallets, ...ApiController._filterOutExtensions(data)], "id");
    state9.count = count > state9.count ? count : state9.count;
    state9.page = page;
  },
    ...
    if (data) {
      data.forEach((wallet) => {
        if (wallet == null ? void 0 : wallet.rdns) {
          state9.excludedRDNS.push(wallet.rdns);
        }
      });
    }
  },
  async searchWallet({ search }) {
    ...
    state9.search = ApiController._filterOutExtensions(data);
  },
  ...
  prefetch() {
    ...
    state9.prefetchPromise = Promise.race([Promise.allSettled(promises)]);
  },
...
var OptionsController = {
  ...
  setOptions(options) {
    Object.assign(state10, options);
  },
  setProjectId(projectId) {
    state10.projectId = projectId;
  },
  setAllWallets(allWallets = ConstantsUtil2.DEFAULT_FEATURES.allWallets) {
    state10.allWallets = allWallets;
  },
  setIncludeWalletIds(includeWalletIds) {
    state10.includeWalletIds = includeWalletIds;
  },
  setExcludeWalletIds(excludeWalletIds) {
    state10.excludeWalletIds = excludeWalletIds;
    if (excludeWalletIds) {
      ApiController.searchWalletByIds({ ids: excludeWalletIds });
    }
  },
  setFeaturedWalletIds(featuredWalletIds) {
    state10.featuredWalletIds = featuredWalletIds;
  },
  setTokens(tokens) {
    state10.tokens = tokens;
  },
  setTermsConditionsUrl(termsConditionsUrl) {
    state10.termsConditionsUrl = termsConditionsUrl;
  },
  setPrivacyPolicyUrl(privacyPolicyUrl) {
    state10.privacyPolicyUrl = privacyPolicyUrl;
  },
  setCustomWallets(customWallets) {
    state10.customWallets = customWallets;
  },
  setIsSiweEnabled(isSiweEnabled) {
    state10.isSiweEnabled = isSiweEnabled;
  },
  setIsUniversalProvider(isUniversalProvider) {
    state10.isUniversalProvider = isUniversalProvider;
  },
  setEnableAnalytics(enableAnalytics = ConstantsUtil2.DEFAULT_FEATURES.analytics) {
    state10.enableAnalytics = enableAnalytics;
  },
  setSdkVersion(sdkVersion) {
    state10.sdkVersion = sdkVersion;
  },
  setMetadata(metadata) {
    state10.metadata = metadata;
  },
  setOnrampEnabled(enableOnramp = ConstantsUtil2.DEFAULT_FEATURES.onramp) {
    state10.enableOnramp = enableOnramp;
  },
  setDisableAppend(disableAppend = ConstantsUtil2.DEFAULT_FEATURES.disableAppend) {
    state10.disableAppend = disableAppend;
  },
  setEIP6963Enabled(enableEIP6963 = ConstantsUtil2.DEFAULT_FEATURES.enableEIP6963) {
    state10.enableEIP6963 = enableEIP6963;
  },
  setHasMultipleAddresses(hasMultipleAddresses) {
    state10.hasMultipleAddresses = hasMultipleAddresses;
  },
  setEnableSwaps(enableSwaps = ConstantsUtil2.DEFAULT_FEATURES.swaps) {
    state10.enableSwaps = enableSwaps;
  }
};
...
var BlockchainApiController = {
  ...
  async generateOnRampURL({ destinationWallets, partnerUserId, defaultNetwork, purchaseAmount, paymentAmount }) {
    const response = await state11.api.post({
  ...
  async getOnrampOptions() {
    try {
      const response = await state11.api.get({
  ...
  setClientId(clientId) {
    state11.clientId = clientId;
    state11.api = new FetchUtil({ baseUrl: baseUrl3, clientId });
  }
};
  ...
  if (check)
    return ZodAny.create().superRefine((data, ctx) => {
      ...
      if (!check(data)) {
        ...
        const _fatal = (_b3 = (_a6 = p.fatal) !== null && _a6 !== void 0 ? _a6 : fatal) !== null && _b3 !== void 0 ? _b3 : true;
    ...
    this.events = {
      registerFrameEventHandler: (id, callback, signal) => {
        function eventHandler({ data }) {
          var _a6;
          if (!((_a6 = data.type) == null ? void 0 : _a6.includes(W3mFrameConstants.FRAME_EVENT_KEY))) {
            return;
          }
      ...
      onAppEvent: (callback) => {
        if (W3mFrameHelpers.isClient) {
          window.addEventListener("message", ({ data }) => {
            var _a6;
            if (!((_a6 = data.type) == null ? void 0 : _a6.includes(W3mFrameConstants.APP_EVENT_KEY))) {
              return;
            }
    ...
    return new Promise((resolve, reject) => {
      ...
      function handler(framEvent) {
        ...
        if (framEvent.type === `@w3m-frame/${type}_SUCCESS`) {
          ...
          if ("payload" in framEvent) {
            reject(new Error(((_a7 = framEvent.payload) == null ? void 0 : _a7.message) || "An error occurred"));
          }
...
var TransactionsController = {
  ...
  async fetchTransactions(accountAddress, onramp) {
    ...
    try {
      const response = await BlockchainApiController.fetchTransactions({
        ...
        chainId: (_a6 = NetworkController.state.caipNetwork) == null ? void 0 : _a6.id
      });
      ...
      if (onramp === "coinbase") {
        state13.coinbaseTransactions = this.groupTransactionsByYearAndMonth(state13.coinbaseTransactions, response.data);
      } else {
        state13.transactions = filteredTransactions;
        state13.transactionsByYear = this.groupTransactionsByYearAndMonth(state13.transactionsByYear, sameChainTransactions);
      }
  ...
  filterByConnectedChain(transactions) {
    var _a6;
    const chainId = (_a6 = NetworkController.state.caipNetwork) == null ? void 0 : _a6.id;
...
var ConnectionController = {
  ...
  async connectExternal(options, chain) {
    var _a6, _b3;
    await ((_b3 = (_a6 = this._getClient(chain)).connectExternal) == null ? void 0 : _b3.call(_a6, options));
    ChainController.setActiveChain(chain);
    StorageUtil.setConnectedConnector(options.type);
  },
  async reconnectExternal(options) {
    var _a6, _b3;
    await ((_b3 = (_a6 = this._getClient()).reconnectExternal) == null ? void 0 : _b3.call(_a6, options));
    StorageUtil.setConnectedConnector(options.type);
  },
  async setPreferredAccountType(accountType) {
    ...
    EventsController.sendEvent({
      ...
      properties: { accountType, network: ((_a6 = NetworkController.state.caipNetwork) == null ? void 0 : _a6.id) || "" }
    });
  },
  ...
  checkInstalled(ids, chain) {
    var _a6, _b3;
    return ((_b3 = (_a6 = this._getClient(chain)).checkInstalled) == null ? void 0 : _b3.call(_a6, ids)) || false;
  },
  resetWcConnection() {
...
var RouterController = {
  ...
  pushTransactionStack(action) {
    state15.transactionStack.push(action);
  },
  popTransactionStack(cancel) {
    var _a6, _b3;
    const action = state15.transactionStack.pop();
    if (!action) {
      return;
    }
    if (cancel) {
  ...
  push(view, data) {
    if (view !== state15.view) {
      state15.view = view;
      state15.history.push(view);
      state15.data = data;
    }
  },
  reset(view) {
    state15.view = view;
    state15.history = [view];
  },
  replace(view, data) {
    if (state15.history.length >= 1 && state15.history.at(-1) !== view) {
      state15.view = view;
      state15.history[state15.history.length - 1] = view;
      state15.data = data;
    }
  },
  goBack() {
    if (state15.history.length > 1) {
      state15.history.pop();
      const [last] = state15.history.slice(-1);
      if (last) {
        state15.view = last;
      }
    }
  ...
  goBackToIndex(historyIndex) {
    if (state15.history.length > 1) {
      state15.history = state15.history.slice(0, historyIndex + 1);
      const [last] = state15.history.slice(-1);
      if (last) {
        state15.view = last;
      }
...
var state16 = proxy(initialState);
var SwapController = {
  state: state16,
  subscribe(callback) {
  ...
  getParams() {
    ...
    const invalidToToken = !((_a6 = state16.toToken) == null ? void 0 : _a6.address) || !((_b3 = state16.toToken) == null ? void 0 : _b3.decimals);
    const invalidSourceToken = !((_c = state16.sourceToken) == null ? void 0 : _c.address) || !((_d = state16.sourceToken) == null ? void 0 : _d.decimals) || !NumberUtil.bigNumber(state16.sourceTokenAmount).isGreaterThan(0);
    const invalidSourceTokenAmount = !state16.sourceTokenAmount;
    return {
      networkAddress,
      fromAddress: address,
      fromCaipAddress: AccountController.state.caipAddress,
      sourceTokenAddress: (_e = state16.sourceToken) == null ? void 0 : _e.address,
      toTokenAddress: (_f = state16.toToken) == null ? void 0 : _f.address,
      toTokenAmount: state16.toTokenAmount,
      toTokenDecimals: (_g = state16.toToken) == null ? void 0 : _g.decimals,
      sourceTokenAmount: state16.sourceTokenAmount,
      sourceTokenDecimals: (_h = state16.sourceToken) == null ? void 0 : _h.decimals,
      invalidToToken,
      invalidSourceToken,
  ...
  setSourceToken(sourceToken) {
    if (!sourceToken) {
      state16.sourceToken = sourceToken;
      state16.sourceTokenAmount = "";
      state16.sourceTokenPriceInUSD = 0;
      return;
    }
    state16.sourceToken = sourceToken;
  ...
  setSourceTokenAmount(amount) {
    state16.sourceTokenAmount = amount;
  },
  setToToken(toToken) {
    if (!toToken) {
      state16.toToken = toToken;
      state16.toTokenAmount = "";
      state16.toTokenPriceInUSD = 0;
      return;
    }
    state16.toToken = toToken;
  ...
  setToTokenAmount(amount) {
    state16.toTokenAmount = amount ? NumberUtil.formatNumberToLocalString(amount, TO_AMOUNT_DECIMALS) : "";
  },
  async setTokenPrice(address, target) {
    const { availableToSwap } = this.getParams();
    let price = state16.tokensPriceMap[address] || 0;
    if (!price) {
      state16.loadingPrices = true;
      price = await this.getAddressPrice(address);
    }
    if (target === "sourceToken") {
      state16.sourceTokenPriceInUSD = price;
    } else if (target === "toToken") {
      state16.toTokenPriceInUSD = price;
    }
    if (state16.loadingPrices) {
      state16.loadingPrices = false;
      if (availableToSwap) {
        this.swapTokens();
      }
    }
  ...
  switchTokens() {
    if (state16.initializing || !state16.initialized) {
      return;
    }
    const newSourceToken = state16.toToken ? { ...state16.toToken } : void 0;
    const newToToken = state16.sourceToken ? { ...state16.sourceToken } : void 0;
    const newSourceTokenAmount = newSourceToken && state16.toTokenAmount === "" ? "1" : state16.toTokenAmount;
  ...
  resetState() {
    state16.myTokensWithBalance = initialState.myTokensWithBalance;
    state16.tokensPriceMap = initialState.tokensPriceMap;
    state16.initialized = initialState.initialized;
    state16.sourceToken = initialState.sourceToken;
    state16.sourceTokenAmount = initialState.sourceTokenAmount;
    state16.sourceTokenPriceInUSD = initialState.sourceTokenPriceInUSD;
    state16.toToken = initialState.toToken;
    state16.toTokenAmount = initialState.toTokenAmount;
    state16.toTokenPriceInUSD = initialState.toTokenPriceInUSD;
    state16.networkPrice = initialState.networkPrice;
    state16.networkTokenSymbol = initialState.networkTokenSymbol;
    state16.networkBalanceInUSD = initialState.networkBalanceInUSD;
    state16.inputError = initialState.inputError;
  },
  resetValues() {
    var _a6;
    const { networkAddress } = this.getParams();
    const networkToken = (_a6 = state16.tokens) == null ? void 0 : _a6.find((token) => token.address === networkAddress);
    this.setSourceToken(networkToken);
    this.setToToken(void 0);
  },
  getApprovalLoadingState() {
    return state16.loadingApprovalTransaction;
  },
  clearError() {
    state16.transactionError = void 0;
  },
  async initializeState() {
    if (state16.initializing) {
      return;
    }
    state16.initializing = true;
    if (!state16.initialized) {
      try {
        await this.fetchTokens();
        state16.initialized = true;
      } catch (error) {
        state16.initialized = false;
        SnackController.showError("Failed to initialize swap");
        RouterController.goBack();
      }
    }
    state16.initializing = false;
  },
  async fetchTokens() {
    var _a6;
    const { networkAddress } = this.getParams();
    ...
    const networkToken = (_a6 = state16.tokens) == null ? void 0 : _a6.find((token) => token.address === networkAddress);
    if (networkToken) {
      state16.networkTokenSymbol = networkToken.symbol;
      this.setSourceToken(networkToken);
  ...
  async getTokenList() {
    ...
    state16.tokens = tokens;
    state16.popularTokens = tokens.sort((aTokenInfo, bTokenInfo) => {
    ...
    state16.suggestedTokens = tokens.filter((token) => {
  ...
  async getAddressPrice(address) {
    var _a6, _b3;
    const existPrice = state16.tokensPriceMap[address];
    if (existPrice) {
      return existPrice;
    }
    ...
    const allTokens = [...state16.tokens || [], ...state16.myTokensWithBalance || []];
    const symbol = (_a6 = allTokens == null ? void 0 : allTokens.find((token) => token.address === address)) == null ? void 0 : _a6.symbol;
    const price = ((_b3 = fungibles.find((p) => p.symbol.toLowerCase() === (symbol == null ? void 0 : symbol.toLowerCase()))) == null ? void 0 : _b3.price) || 0;
    const priceAsFloat = parseFloat(price.toString());
    state16.tokensPriceMap[address] = priceAsFloat;
    return priceAsFloat;
  },
  async getNetworkTokenPrice() {
    ...
    state16.tokensPriceMap[networkAddress] = parseFloat(price);
    state16.networkTokenSymbol = (token == null ? void 0 : token.symbol) || "";
    state16.networkPrice = price;
  },
  async getMyTokensWithBalance(forceUpdate) {
  ...
  setBalances(balances) {
    ...
    balances.forEach((token) => {
      state16.tokensPriceMap[token.address] = token.price || 0;
    });
    state16.myTokensWithBalance = balances.filter((token) => token.address.startsWith(caipNetwork.id));
  ...
  async getInitialGasPrice() {
    ...
    switch ((_a6 = NetworkController.state.caipNetwork) == null ? void 0 : _a6.chain) {
      case "solana":
        state16.gasFee = res.standard;
        state16.gasPriceInUSD = NumberUtil.multiply(res.standard, state16.networkPrice).dividedBy(1e9).toNumber();
        return {
          gasPrice: BigInt(state16.gasFee),
          gasPriceInUSD: Number(state16.gasPriceInUSD)
        };
      case "evm":
      default:
        ...
        const gasPrice = SwapCalculationUtil.getGasPriceInUSD(state16.networkPrice, gasLimit, gasFee);
        state16.gasFee = value;
        state16.gasPriceInUSD = gasPrice;
  ...
  async swapTokens() {
    var _a6, _b3;
    const address = AccountController.state.address;
    const sourceToken = state16.sourceToken;
    const toToken = state16.toToken;
    const haveSourceTokenAmount = NumberUtil.bigNumber(state16.sourceTokenAmount).isGreaterThan(0);
    if (!toToken || !sourceToken || state16.loadingPrices || !haveSourceTokenAmount) {
      return;
    }
    state16.loadingQuote = true;
    const amountDecimal = NumberUtil.bigNumber(state16.sourceTokenAmount).multipliedBy(10 ** sourceToken.decimals);
    const quoteResponse = await BlockchainApiController.fetchSwapQuote({
      userAddress: address,
      projectId: OptionsController.state.projectId,
      from: sourceToken.address,
      to: toToken.address,
      gasPrice: state16.gasFee,
      amount: amountDecimal.toString()
    });
    state16.loadingQuote = false;
    ...
    const isInsufficientToken = this.hasInsufficientToken(state16.sourceTokenAmount, sourceToken.address);
    if (isInsufficientToken) {
      state16.inputError = "Insufficient balance";
    } else {
      state16.inputError = void 0;
  ...
  async getTransaction() {
    ...
    const sourceToken = state16.sourceToken;
    const toToken = state16.toToken;
    if (!fromCaipAddress || !availableToSwap || !sourceToken || !toToken || state16.loadingQuote) {
      return void 0;
    }
    try {
      state16.loadingBuildTransaction = true;
      ...
      state16.loadingBuildTransaction = false;
      state16.fetchError = false;
      return transaction;
    } catch (error) {
      RouterController.goBack();
      SnackController.showError("Failed to check allowance");
      state16.loadingBuildTransaction = false;
      state16.approvalTransaction = void 0;
      state16.swapTransaction = void 0;
      state16.fetchError = true;
      return void 0;
    }
  },
  async createAllowanceTransaction() {
    ...
    try {
      ...
      const transaction = {
        ...
        toAmount: state16.toTokenAmount
      };
      state16.swapTransaction = void 0;
      state16.approvalTransaction = transaction;
      return transaction;
    } catch (error) {
      RouterController.goBack();
  ...
  async createSwapTransaction() {
    ...
    try {
      ...
      state16.gasPriceInUSD = SwapCalculationUtil.getGasPriceInUSD(state16.networkPrice, gas, gasPrice);
      state16.approvalTransaction = void 0;
      state16.swapTransaction = transaction;
      return transaction;
    } catch (error) {
      RouterController.goBack();
  ...
  async sendTransactionForApproval(data) {
    ...
    state16.loadingApprovalTransaction = true;
    ...
    try {
      ...
      state16.approvalTransaction = void 0;
      state16.loadingApprovalTransaction = false;
    } catch (err) {
      const error = err;
      state16.transactionError = error == null ? void 0 : error.shortMessage;
      state16.loadingApprovalTransaction = false;
      SnackController.showError((error == null ? void 0 : error.shortMessage) || "Transaction error");
    }
  },
  async sendTransactionForSwap(data) {
    var _a6, _b3, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l;
    if (!data) {
      return void 0;
    }
    const { fromAddress, toTokenAmount, isAuthConnector } = this.getParams();
    state16.loadingTransaction = true;
    const snackbarPendingMessage = `Swapping ${(_a6 = state16.sourceToken) == null ? void 0 : _a6.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_b3 = state16.toToken) == null ? void 0 : _b3.symbol}`;
    const snackbarSuccessMessage = `Swapped ${(_c = state16.sourceToken) == null ? void 0 : _c.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_d = state16.toToken) == null ? void 0 : _d.symbol}`;
    if (isAuthConnector) {
      RouterController.pushTransactionStack({
        view: "Account",
        goBack: false,
    ...
    try {
      const forceUpdateAddresses = [(_e = state16.sourceToken) == null ? void 0 : _e.address, (_f = state16.toToken) == null ? void 0 : _f.address].join(",");
      ...
      state16.loadingTransaction = false;
  ...
  hasInsufficientToken(sourceTokenAmount, sourceTokenAddress) {
    const isInsufficientSourceTokenForSwap = SwapCalculationUtil.isInsufficientSourceTokenForSwap(sourceTokenAmount, sourceTokenAddress, state16.myTokensWithBalance);
    const insufficientNetworkTokenForGas = SwapCalculationUtil.isInsufficientNetworkTokenForGas(state16.networkBalanceInUSD, state16.gasPriceInUSD);
  ...
  setTransactionDetails() {
    ...
    state16.gasPriceInUSD = SwapCalculationUtil.getGasPriceInUSD(state16.networkPrice, BigInt(state16.gasFee), BigInt(INITIAL_GAS_LIMIT));
    state16.priceImpact = SwapCalculationUtil.getPriceImpact({
      sourceTokenAmount: state16.sourceTokenAmount,
      sourceTokenPriceInUSD: state16.sourceTokenPriceInUSD,
      toTokenPriceInUSD: state16.toTokenPriceInUSD,
      toTokenAmount: state16.toTokenAmount
    });
    state16.maxSlippage = SwapCalculationUtil.getMaxSlippage(state16.slippage, state16.toTokenAmount);
    state16.providerFee = SwapCalculationUtil.getProviderFee(state16.sourceTokenAmount);
  }
};
...
var AccountController = {
  ...
  replaceState(newState) {
    ...
    Object.assign(state17, ref(newState));
  },
  subscribe(callback) {
  ...
  async fetchTokenBalance() {
    var _a6, _b3;
    const chainId = (_a6 = NetworkController.state.caipNetwork) == null ? void 0 : _a6.id;
    const chain = (_b3 = NetworkController.state.caipNetwork) == null ? void 0 : _b3.chain;
    const address = AccountController.state.address;
    try {
  ...
  async getQuote() {
    ...
    try {
      const quote = await BlockchainApiController.getOnrampQuote({
        ...
        amount: ((_a6 = state19.paymentAmount) == null ? void 0 : _a6.toString()) || "0",
...
var SendController = {
  ...
  sendToken() {
    var _a6;
    switch ((_a6 = ChainController.state.activeCaipNetwork) == null ? void 0 : _a6.chain) {
      case "evm":
        this.sendEvmToken();
        return;
      case "solana":
    ...
    if (((_a6 = this.state.token) == null ? void 0 : _a6.address) && this.state.sendTokenAmount && this.state.receiverAddress) {
      EventsController.sendEvent({
        ...
        properties: {
          ...
          network: ((_b3 = NetworkController.state.caipNetwork) == null ? void 0 : _b3.id) || ""
        }
      });
      this.sendERC20Token({
...
// node_modules/@web3modal/ui/dist/esm/src/composites/wui-profile-button-v2/index.js
...
WuiProfileButtonV2.styles = [resetStyles, elementStyles, styles_default59];
__decorate59([
  property()
...
WuiProfileButtonV2 = __decorate59([
...
WuiChipButton.styles = [resetStyles, elementStyles, styles_default60];
__decorate60([
  property()
...
WuiCompatibleNetwork.styles = [resetStyles, elementStyles, styles_default61];
__decorate61([
  property({ type: Array })
...
WuiCompatibleNetwork = __decorate61([
...
WuiBanner.styles = [resetStyles, elementStyles, styles_default62];
__decorate62([
  property()
...
WuiBanner = __decorate62([
  customElement("wui-banner")
], WuiBanner);

// node_modules/@web3modal/ui/dist/esm/src/composites/wui-banner-img/styles.js
...
// node_modules/@web3modal/ui/dist/esm/src/composites/wui-banner-img/index.js
...
WuiBannerImg.styles = [resetStyles, elementStyles, styles_default63];
__decorate63([
  property()
...
WuiListToken.styles = [resetStyles, elementStyles, styles_default64];
__decorate64([
  property()
...
WuiListDescription.styles = [resetStyles, elementStyles, styles_default65];
__decorate65([
  property()
...
WuiListDescription = __decorate65([
...
WuiInputAmount.styles = [resetStyles, elementStyles, styles_default66];
__decorate66([
  property({ type: Boolean })
...
WuiPreviewItem.styles = [resetStyles, elementStyles, styles_default67];
__decorate67([
  property()
...
WuiPreviewItem = __decorate67([
  customElement("wui-preview-item")
], WuiPreviewItem);

// node_modules/@web3modal/ui/dist/esm/src/composites/wui-list-account/styles.js
...
// node_modules/@web3modal/ui/dist/esm/src/composites/wui-list-account/index.js
...
var WuiListAccount = class WuiListAccount2 extends LitElement {
  ...
  connectedCallback() {
    var _a6;
    super.connectedCallback();
    BlockchainApiController.getBalance(this.accountAddress, (_a6 = this.caipNetwork) == null ? void 0 : _a6.id).then((response) => {
...
WuiListAccount.styles = [resetStyles, elementStyles, styles_default68];
__decorate68([
  property()
...
WuiIconButton.styles = [resetStyles, elementStyles, styles_default69];
__decorate69([
  property()
...
WuiListButton.styles = [resetStyles, elementStyles, styles_default70];
__decorate70([
  property()
...
WuiListSocial.styles = [resetStyles, elementStyles, styles_default71];
__decorate71([
  property()
...
WuiListSocial = __decorate71([
  customElement("wui-list-social")
], WuiListSocial);

// node_modules/@web3modal/ui/dist/esm/src/composites/wui-select/styles.js
...
// node_modules/@web3modal/ui/dist/esm/src/composites/wui-select/index.js
...
WuiSelect.styles = [resetStyles, elementStyles, colorStyles, styles_default72];
__decorate72([
  property()
], WuiSelect.prototype, "imageSrc", void 0);
WuiSelect = __decorate72([
...
WuiGrid.styles = [resetStyles, styles_default73];
__decorate73([
  property()
...
WuiSeparator.styles = [resetStyles, styles_default74];
__decorate74([
  property()
], WuiSeparator.prototype, "text", void 0);
WuiSeparator = __decorate74([
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IKGJ53EA.js.map
