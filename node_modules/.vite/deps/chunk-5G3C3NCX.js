import {
  ...
  toBlobSidecars,
  toRlp
} from "./chunk-NXWBFQTA.js";
import {
  equalBytes,
  secp256k1
} from "./chunk-P3XWFZ4H.js";
import {
  HashMD
} from "./chunk-TDGQX2AI.js";
import {
  addressResolverAbi,
  call,
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-MNCIDAFX.js").then((module) => module.WebSocket);
...
//# sourceMappingURL=chunk-5G3C3NCX.js.map
