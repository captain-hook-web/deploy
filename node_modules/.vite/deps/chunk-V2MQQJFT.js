...
import {
  ...
  useForkRef_default
} from "./chunk-7IKUP7WY.js";
import {
  require_prop_types
} from "./chunk-WENXT6RZ.js";
import {
  require_jsx_runtime
...
function useMediaQueryOld(query, defaultMatches, matchMedia, ssrMatchMedia, noSsr) {
  const [match, setMatch] = React10.useState(() => {
    if (noSsr && matchMedia) {
...
function useCurrentColorScheme(options) {
  ...
  const handleMediaQuery = React17.useCallback((event) => {
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React18.createContext(void 0);
  if (true) {
  ...
  function CssVarsProvider(props) {
    ...
    const ctx = React18.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime8.jsxs)(React18.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime8.jsxs)(React18.Fragment, {
...
function createContainer(options = {}) {
  ...
  const Container2 = React19.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React20.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React20.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React20.useContext(GridOverflowContext);
    const {
      className,
      children: children2,
    ...
    let result = (0, import_jsx_runtime10.jsx)(GridRoot, _extends({
      ...
      children: React20.Children.map(children2, (child) => {
        if (React20.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
function joinChildren(children2, separator) {
  const childrenArray = React21.Children.toArray(children2).filter(Boolean);
  return childrenArray.reduce((output, child, index) => {
    output.push(child);
    if (index < childrenArray.length - 1) {
      output.push(React21.cloneElement(separator, {
        key: `separator-${index}`
      }));
    }
    return output;
...
function createStack(options = {}) {
  ...
  const Stack2 = React21.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
var Backdrop = React24.forwardRef(function Backdrop2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(TransitionComponent, _extends({
    ...
    children: (0, import_jsx_runtime13.jsx)(BackdropRoot, _extends({
      "aria-hidden": true
    }, rootSlotProps, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-V2MQQJFT.js.map
